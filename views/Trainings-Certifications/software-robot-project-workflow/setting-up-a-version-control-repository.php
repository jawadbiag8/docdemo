<section id="contentpage" class="content">
    <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <h2>Create a New Project in Gitlab</h2>
        ...
        <!-- #END# Headings -->
        <aside class="cdpwWb">
            <div class="float-right m-b-50"><a class="next-btn" href="documantation.php?page=Trainings-Certifications&node=software-robot-project-workflow&subnode=Git-using-Autosphere-studio">Next chapter</a></div>
            <div class="m-b-50"><a class="next-btn" href="documantation.php?page=Trainings-Certifications&node=software-robot-project-workflow&subnode=prerequisites">previous chapter </a></div>
        </aside>
    </div>
</section>
