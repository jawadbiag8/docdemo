        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <h2>Sign up and Sign in on Gitlab</h2>
                        <aside class="sc-hHftDr ewYhue">
                            <div class="m-b-15"><span class="hAIwHX m-r-10">beginner</span><small>Time to complete ~1 hour</small>
                            </div>
                        </aside>
                        <h4 id="mild-interest-in-software-robot-development">Signing up on Gitlab</h4>
                        <h4 id="mild-interest-in-software-robot-development">Gitlab</h4>

                        <p> <strong>What is Gitlab?</strong> GitLab is a web-based DevOps lifecycle tool that provides a Git-repository manager providing wiki, issue-tracking and continuous integration and deployment pipeline features, using an open-source license,
