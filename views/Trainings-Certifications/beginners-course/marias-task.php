            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <p>As a professional, you want to make documentation for your automation project. Also, you know you will never remember all of this if you don&#x27;t write it down.</p>
                        <p>You fire up Word and create a <strong>Process Definition Document</strong> to describe the process accurately:
                        </p>
                        <!--
                        ...
                        <ul>
                            <li>Before it can be automated, a process needs to be documented.</li>
