...
Insert the sales data for the week and export it as a PDF
    ...
    Fill And Submit The Form
        ...
        <!-- #END# Headings -->
        <aside class="cdpwWb">
            <div class="float-right m-b-50"><a class="next-btn" href="documantation.php?page=Trainings-Certifications&node=beginners-course&subnode=downloading-the-excel-file">Next chapter</a></div>
            <div class="m-b-50"><a class="next-btn" href="documantation.php?page=Trainings-Certifications&node=beginners-course&subnode=logging-in">previous chapter</a></div>
        </aside>
    </div>
</section>