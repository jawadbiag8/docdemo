...
Collect The Results
                    ...
                    <h2 id="taking-a-screenshot"><button type="button"><svg height="16" width="16">
                                <path
                                    d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z">
                                </path>
                            </svg></button>Taking a screenshot</h2>
                    ...
                    <h3 id="locating-the-element"><button type="button"><svg height="16" width="16">
                                <path
                                    d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z">
                                </path>
                            </svg></button>Locating the element</h3>
...
...
                    ...
                    <p>We have a <code>div</code> element. It has <code>class</code> and <code>role</code> attributes. Since there are no <code>id</code> or <code>name</code> attributes to work with, we decide to use the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS"
                            target="_blank" rel="noopener noreferrer">CSS</a> classes to target it. The <code>sales-summary</code> class seems like a good candidate because then it will be clear in our script what we are taking a screenshot of. Because we
                    ...
                    <blockquote>
                        <p>Using the CSS strategy, find me a <code>div</code> element that has the
                            <code>sales-summary</code> CSS class.</p>
                    </blockquote>
...
Insert the sales data for the week and export it as a PDF
    ...
    Collect The Results
                    ...
                    <aside class="sc-kfzAmx cdpwWb">
                        <div><a class="pagination" href="docs.php?page=courses/beginners-course/filling-in-the-sales-form-using-excel-data">Previous
                                chapter</a></div>
                        <div><a class="pagination" href="docs.php?page=courses/beginners-course/creating-pdf">Next chapter</a></div>
                    </aside>
                </article>
