                ...
                <path
                  ...
                  fill="#002642"></path>
                        ...
                        <nav class="sc-giIncl cuybkK"><a class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-pdf">Readme</a><a aria-current="page" class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-pdf/keywords">Keywords</a></nav>
                    </div>
                  ...
                  Break</a><a id="link-add-font" href="#add-font" class="">Add Font</a><a id="link-add-image-to-pdf" href="#add-image-to-pdf" class="">Add Image To Pdf</a><a id="link-add-link" href="#add-link" class="">Add Link</a>
                                <a id="link-add-page" href="#add-page" class="">Add Page</a><a id="link-add-pages" href="#add-pages" class="">Add Pages</a><a id="link-add-pages-to-document" href="#add-pages-to-document"
                                    class="">Add Pages To Document</a><a id="link-alias-nb-pages" href="#alias-nb-pages" class="">Alias Nb Pages</a><a id="link-cell" href="#cell" class="">Cell</a><a id="link-check-page" href="#check-page"
                                    class="">Check Page</a><a id="link-close" href="#close" class="">Close</a><a id="link-close-all-pdf-documents" href="#close-all-pdf-documents" class="">Close All Pdf Documents</a><a id="link-close-pdf-document"
                                    href="#close-pdf-document" class="">Close Pdf Document</a><a id="link-code-39" href="#code-39" class="">Code 39</a><a id="link-dashed-line" href="#dashed-line" class="">Dashed Line</a>
                                ...
                                <a id="link-extract-pages-from-pdf" href="#extract-pages-from-pdf" class="">Extract Pages From Pdf</a><a id="link-footer" href="#footer" class="">Footer</a><a id="link-get-all-figures" href="#get-all-figures"
                                    class="">Get All
                  Figures</a><a id="link-get-info" href="#get-info" class="">Get Info</a><a id="link-get-input-fields" href="#get-input-fields" class="">Get Input Fields</a><a id="link-get-number-of-pages" href="#get-number-of-pages"
                                    class="">Get Number Of
                  ...
                  Text From Pdf</a><a id="link-get-value-from-anchor" href="#get-value-from-anchor" class="">Get Value From Anchor</a><a id="link-get-x" href="#get-x" class="">Get X</a><a id="link-get-y" href="#get-y"
                                    class="">Get Y</a><a id="link-header" href="#header" class="">Header</a><a id="link-html-to-pdf" href="#html-to-pdf" class="">Html To Pdf</a><a id="link-image" href="#image" class="">Image</a>
                                <a id="link-interleaved-2-of-5" href="#interleaved-2-of-5" class="">Interleaved 2 Of 5</a><a id="link-is-pdf-encrypted" href="#is-pdf-encrypted" class="">Is Pdf Encrypted</a><a id="link-line" href="#line"
                                    class="">Line</a><a id="link-link" href="#link" class="">Link</a><a id="link-ln" href="#ln" class="">Ln</a><a id="link-multi-cell" href="#multi-cell" class="">Multi Cell</a><a id="link-normalize-text"
                                    href="#normalize-text" class="">Normalize Text</a><a id="link-open" href="#open" class="">Open</a><a id="link-open-pdf-document" href="#open-pdf-document" class="">Open Pdf Document</a>
                                <a
                                    id="link-output" href="#output" class="">Output</a><a id="link-page-no" href="#page-no" class="">Page No</a><a id="link-page-rotate" href="#page-rotate" class="">Page
                  ...
                  Compression</a><a id="link-set-creator" href="#set-creator" class="">Set Creator</a><a id="link-set-display-mode" href="#set-display-mode" class="">Set Display Mode</a><a id="link-set-draw-color" href="#set-draw-color"
                                        class="">Set Draw Color</a><a id="link-set-field-value" href="#set-field-value" class="">Set Field Value</a><a id="link-set-fill-color" href="#set-fill-color" class="">Set Fill Color</a>
                                    <a id="link-set-font" href="#set-font" class="">Set Font</a><a id="link-set-font-size" href="#set-font-size" class="">Set Font Size</a><a id="link-set-keywords" href="#set-keywords"
                                        class="">Set Keywords</a><a id="link-set-left-margin" href="#set-left-margin" class="">Set Left Margin</a><a id="link-set-line-width" href="#set-line-width" class="">Set Line Width</a>
                                    <a id="link-set-link" href="#set-link" class="">Set Link</a><a id="link-set-margins" href="#set-margins" class="">Set Margins</a><a id="link-set-output-directory" href="#set-output-directory"
                                        class="">Set Output Directory</a>
                                    <a id="link-set-right-margin" href="#set-right-margin" class="">Set Right Margin</a><a id="link-set-subject" href="#set-subject" class="">Set Subject</a><a id="link-set-text-color" href="#set-text-color"
                                        class="">Set Text Color</a><a id="link-set-title" href="#set-title" class="">Set Title</a><a id="link-set-top-margin" href="#set-top-margin" class="">Set Top Margin</a>
                  ...
                  Document</a><a id="link-template-html-to-pdf" href="#template-html-to-pdf" class="">Template Html To Pdf</a><a id="link-text" href="#text" class="">Text</a><a id="link-update-field-values" href="#update-field-values"
                                        class="">Update Field
                  Values</a><a id="link-write" href="#write" class="">Write</a><a id="link-write-html" href="#write-html" class="">Write Html</a></div>
                        </aside>
                    </div>
                </article>
