                ...
                <path
                  ...
                  fill="#002642"></path>
                        ...
                        <nav class="sc-giIncl cuybkK"><a class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-email-imapsmtp">Readme</a><a aria-current="page" class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-email-imapsmtp/keywords">Keywords</a></nav>
                    </div>
...
&#64;{emails}  Wait For Message  SUBJECT &quot;Autosphere task&quot;  timeout=300  interval=10
                    ...
                    <path
                      ...
                      fill="#fff"></path>
                            ...
                            <div><a id="link-authorize" href="#authorize" class="">Authorize</a><a id="link-authorize-imap" href="#authorize-imap" class="">Authorize Imap</a><a id="link-authorize-smtp" href="#authorize-smtp"
                                    class="">Authorize Smtp</a><a id="link-create-folder" href="#create-folder" class="">Create Folder</a><a id="link-delete-folder" href="#delete-folder" class="">Delete Folder</a><a id="link-delete-message"
                                    href="#delete-message" class="">Delete Message</a><a id="link-delete-messages" href="#delete-messages" class="">Delete Messages</a><a id="link-flag-messages" href="#flag-messages"
                                    class="">Flag Messages</a><a id="link-get-folder-list" href="#get-folder-list" class="">Get Folder List</a><a id="link-list-messages" href="#list-messages" class="">List Messages</a><a id="link-mark-as-read"
                                    href="#mark-as-read" class="">Mark As Read</a><a id="link-mark-as-unread" href="#mark-as-unread" class="">Mark As Unread</a><a id="link-rename-folder" href="#rename-folder" class="">Rename Folder</a>
                                <a id="link-save-attachment" href="#save-attachment" class="">Save Attachment</a><a id="link-save-attachments" href="#save-attachments" class="">Save Attachments</a><a id="link-save-messages" href="#save-messages"
                                    class="">Save Messages</a><a id="link-select-folder" href="#select-folder" class="">Select Folder</a><a id="link-send-message" href="#send-message" class="">Send Message</a><a id="link-send-smtp-hello"
                                    href="#send-smtp-hello" class="">Send Smtp Hello</a>
                                <a id="link-set-credentials" href="#set-credentials" class="">Set Credentials</a><a id="link-unflag-messages" href="#unflag-messages" class="">Unflag Messages</a><a id="link-wait-for-message" href="#wait-for-message"
                                    class="">Wait For Message</a></div>
                        </aside>
                    </div>
                </article>
