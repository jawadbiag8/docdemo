                ...
                <path
                  ...
                  fill="#002642"></path>
                        ...
                        <nav class="sc-giIncl cuybkK"><a class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-filesystem">Readme</a><a aria-current="page" class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-filesystem/keywords">Keywords</a></nav>
                    </div>
...
Run keyword if file exists    orders.xlsx    Process orders
                  ...
                  Directory</a><a id="link-copy-file" href="#copy-file" class="">Copy File</a><a id="link-copy-files" href="#copy-files" class="">Copy Files</a><a id="link-create-binary-file" href="#create-binary-file"
                                    class="">Create Binary File</a><a id="link-create-directory" href="#create-directory" class="">Create Directory</a><a id="link-create-file" href="#create-file" class="">Create File</a><a id="link-does-directory-exist"
                                    href="#does-directory-exist" class="">Does Directory
                  Exist</a><a id="link-does-directory-not-exist" href="#does-directory-not-exist" class="">Does Directory Not Exist</a><a id="link-does-file-exist" href="#does-file-exist" class="">Does File Exist</a><a id="link-does-file-not-exist"
                                    href="#does-file-not-exist" class="">Does File Not Exist</a><a id="link-empty-directory" href="#empty-directory" class="">Empty Directory</a><a id="link-find-files" href="#find-files"
                                    class="">Find
                  ...
                  File Creation Date</a><a id="link-get-file-extension" href="#get-file-extension" class="">Get File Extension</a><a id="link-get-file-modified-date" href="#get-file-modified-date" class="">Get File Modified Date</a>
                                <a id="link-get-file-name" href="#get-file-name" class="">Get File Name</a><a id="link-get-file-size" href="#get-file-size" class="">Get File Size</a><a id="link-is-directory-empty" href="#is-directory-empty"
                                    class="">Is Directory Empty</a><a id="link-is-directory-not-empty" href="#is-directory-not-empty" class="">Is Directory Not
                  Empty</a><a id="link-is-file-empty" href="#is-file-empty" class="">Is File Empty</a><a id="link-is-file-not-empty" href="#is-file-not-empty" class="">Is File Not Empty</a><a id="link-join-path" href="#join-path"
                                    class="">Join Path</a><a id="link-list-directories-in-directory" href="#list-directories-in-directory" class="">List Directories In Directory</a><a id="link-list-files-in-directory" href="#list-files-in-directory"
                                    class="">List Files In Directory</a><a id="link-log-directory-tree" href="#log-directory-tree" class="">Log Directory Tree</a><a id="link-move-directory" href="#move-directory" class="">Move Directory</a>
                                <a id="link-move-file" href="#move-file" class="">Move File</a><a id="link-move-files" href="#move-files" class="">Move Files</a><a id="link-normalize-path" href="#normalize-path"
                                    class="">Normalize Path</a><a id="link-read-binary-file" href="#read-binary-file" class="">Read Binary File</a><a id="link-read-file" href="#read-file" class="">Read File</a><a id="link-remove-directory"
                                    href="#remove-directory" class="">Remove Directory</a><a id="link-remove-file" href="#remove-file" class="">Remove File</a><a id="link-remove-files" href="#remove-files" class="">Remove Files</a>
                                <a id="link-run-keyword-if-file-exists" href="#run-keyword-if-file-exists" class="">Run Keyword If File Exists</a><a id="link-touch-file" href="#touch-file" class="">Touch File</a><a id="link-wait-until-created"
                                    href="#wait-until-created" class="">Wait Until Created</a>
