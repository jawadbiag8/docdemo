                ...
                <path
                  ...
                  fill="#002642"></path>
                        ...
                        <nav class="sc-giIncl cuybkK"><a class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-desktop-windows">Readme</a><a aria-current="page" class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-desktop-windows/keywords">Keywords</a></nav>
                    </div>
                                    ...
                                    <div class="keyword" id="is-element-matching">
                                        ...
                                        <div>
                                            <p class="shortdoc">Is element matching. Check if locator is found in <cite>any</cite> field or
                                                <cite>criteria</cite> field in the window items.</p>
                                            <h3>Arguments</h3>
                                            <table class="arguments">
                                                <tr>
                                                    <th>Argument</th>
...
&#64;{elements}  Wait For Element  Results   timeout=10  interval=1.5
                    ...
                    <path
                      ...
                      fill="#fff"></path>
                            ...
                            <div><a id="link-boot-time-in-seconds-from-epoch" href="#boot-time-in-seconds-from-epoch" class="">Boot Time In Seconds From Epoch</a><a id="link-calculate-rectangle-center" href="#calculate-rectangle-center"
                                    class="">Calculate Rectangle Center</a><a id="link-click-type" href="#click-type" class="">Click Type</a><a id="link-close-all-applications" href="#close-all-applications" class="">Close All
                  ...
                  Pid</a><a id="link-drag-and-drop" href="#drag-and-drop" class="">Drag And Drop</a><a id="link-find-element" href="#find-element" class="">Find Element</a><a id="link-get-app" href="#get-app" class="">Get App</a>
                                <a id="link-get-boot-time" href="#get-boot-time" class="">Get Boot Time</a><a id="link-get-dialog-rectangle" href="#get-dialog-rectangle" class="">Get Dialog Rectangle</a><a id="link-get-element"
                                    href="#get-element" class="">Get Element</a><a id="link-get-element-center" href="#get-element-center" class="">Get Element Center</a><a id="link-get-element-rectangle" href="#get-element-rectangle"
                                    class="">Get Element
                  Rectangle</a><a id="link-get-element-rich-text" href="#get-element-rich-text" class="">Get Element Rich Text</a><a id="link-get-machine-name" href="#get-machine-name" class="">Get Machine Name</a><a id="link-get-memory-stats"
                                    href="#get-memory-stats" class="">Get Memory Stats</a><a id="link-get-open-applications" href="#get-open-applications" class="">Get Open Applications</a><a id="link-get-spaced-string" href="#get-spaced-string"
                                    class="">Get Spaced String</a><a id="link-get-text" href="#get-text" class="">Get Text</a><a id="link-get-username" href="#get-username" class="">Get Username</a><a id="link-get-window-elements"
                                    href="#get-window-elements" class="">Get Window Elements</a><a id="link-get-window-list" href="#get-window-list" class="">Get Window List</a><a id="link-is-element-enabled" href="#is-element-enabled"
                                    class="">Is Element Enabled</a><a id="link-is-element-matching" href="#is-element-matching" class="">Is Element
                  ...
                  Process By Pid</a><a id="link-lock-screen" href="#lock-screen" class="">Lock Screen</a><a id="link-log-in" href="#log-in" class="">Log In</a><a id="link-menu-select" href="#menu-select" class="">Menu Select</a>
                                <a id="link-minimize-dialog" href="#minimize-dialog" class="">Minimize Dialog</a><a id="link-mouse-click" href="#mouse-click" class="">Mouse Click</a><a id="link-mouse-click-coords" href="#mouse-click-coords"
                                    class="">Mouse Click Coords</a><a id="link-mouse-click-image" href="#mouse-click-image" class="">Mouse Click Image</a><a id="link-open-application" href="#open-application" class="">Open Application</a>
                                <a id="link-open-dialog" href="#open-dialog" class="">Open Dialog</a><a id="link-open-executable" href="#open-executable" class="">Open Executable</a><a id="link-open-file" href="#open-file"
                                    class="">Open File</a><a id="link-open-from-search" href="#open-from-search" class="">Open From Search</a><a id="link-open-using-run-dialog" href="#open-using-run-dialog" class="">Open Using Run Dialog</a>
                  ...
                  Dialog</a><a id="link-screenshot" href="#screenshot" class="">Screenshot</a><a id="link-send-keys" href="#send-keys" class="">Send Keys</a><a id="link-send-keys-to-input" href="#send-keys-to-input"
                                    class="">Send Keys To Input</a><a id="link-set-windows-backend" href="#set-windows-backend" class="">Set Windows
                  ...
                  Into</a><a id="link-type-keys" href="#type-keys" class="">Type Keys</a><a id="link-wait-for-element" href="#wait-for-element" class="">Wait For Element</a></div>
                        </aside>
                    </div>
                </article>
