                ...
                <path
                  ...
                  fill="#002642"></path>
                        ...
                        <nav class="sc-giIncl cuybkK"><a class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-dialogs">Readme</a><a aria-current="page" class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/Autosphere-framework/Autosphere-dialogs/keywords">Keywords</a></nav>
                    </div>
...
Add Textarea       name=texts  rows=40   cols=80
                                    ...
                                    <div class="keyword" id="add-title">
                                        ...
                                        <div>
                                            <p class="shortdoc">Add h3 element into form</p>
                                            <h3>Arguments</h3>
                                            <table class="arguments">
                                                <tr>
                                                    <th>Argument</th>
...
&amp;{response}    Request Response
                    ...
                    <path
                      ...
                      fill="#fff"></path>
                            ...
                            <div><a id="link-add-checkbox" href="#add-checkbox" class="">Add Checkbox</a><a id="link-add-dropdown" href="#add-dropdown" class="">Add Dropdown</a><a id="link-add-file-input" href="#add-file-input"
                                    class="">Add File Input</a><a id="link-add-hidden-input" href="#add-hidden-input" class="">Add Hidden Input</a><a id="link-add-radio-buttons" href="#add-radio-buttons" class="">Add Radio Buttons</a>
                                ...
                                <a id="link-add-textarea" href="#add-textarea" class="">Add Textarea</a><a id="link-add-title" href="#add-title" class="">Add Title</a><a id="link-create-form" href="#create-form"
                                    class="">Create Form</a><a id="link-request-response" href="#request-response" class="">Request Response</a></div>
                        </aside>
                    </div>
                </article>
