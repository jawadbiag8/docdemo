                                        ...
                                        <aside class="sc-iJuUWI jaFBcT">
                                            ...
                                            <div>
                                                <ul id="myUL" style="list-style-type: none; padding: 0; margin: 0;">
                                                    <li><a id="link-set-screenshot-directory" href="#set-screenshot-directory" class="">Set Screenshot Directory</a></li>
                                                    <li><a id="link-take-screenshot" href="#take-screenshot" class="">Take Screenshot</a></li>
                                                    <li><a id="link-take-screenshot-without-embedding" href="#take-screenshot-without-embedding" class="">Take Screenshot Without Embedding</a></li>
                                                </ul>
