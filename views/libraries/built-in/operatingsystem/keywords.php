                ...
                <path
                  ...
                  fill="#002642"></path>
                        ...
                        <nav class="sc-giIncl cuybkK"><a class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/built-in/operatingsystem">Readme</a><a aria-current="page" class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/built-in/operatingsystem/keywords">Keywords</a></nav>
                    </div>
                                    ...
                                    <div class="keyword" id="copy-file">
                                        ...
                                        <div>
                                            ...
                                            <p>3) If the destination does not exist and it ends with a path separator (<code>/</code> or
                                                <code>\</code>), it is considered a directory. That directory is created and a source file copied into it. Possible missing intermediate directories are also created.</p>
                                    ...
                                    <div class="keyword" id="get-modified-time">
                                        ...
                                        <div>
                                            ...
                                            <p>2) If <code>format</code> contains any of the words <code>year</code>, <code>month</code>,
                                                ...
                                                the words in <code>format</code> is not significant. The parts are returned as zero-padded strings (e.g. May -&gt; <code>05</code>).</p>
                                    ...
                                    <div class="keyword" id="list-directory">
                                        ...
                                        <div>
                                            ...
                                            <p>File and directory names are returned relative to the given path (e.g. <code>'file.txt'</code>) by default. If you want them be returned in absolute format (e.g.
                                                ...
                                                <a href="#Boolean%20arguments" class="name">Boolean arguments</a>).</p>
                                    ...
                                    <div class="keyword" id="log-file">
                                        ...
                                        <div>
                                            ...
                                            <p>See <a href="#Get%20File" class="name">Get File</a> for more information about
                                                <code>encoding</code> and <code>encoding_errors</code> arguments.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="keyword" id="move-directory">
                                        ...
                                        <div>
                                            ...
                                            <p>Uses <a href="#Copy%20Directory" class="name">Copy Directory</a> keyword internally, and
                                                <code>source</code> and <code>destination</code> arguments have exactly same semantics as with that keyword.</p>
                                        </div>
                                    </div>
                          ...
                          Files</a> keyword.</p>
                                    ...
                                    <div class="keyword" id="run">
                                        ...
                                        <div>
                                            ...
                                            <p>The execution status of the command <b>is not checked</b> by this keyword, and it must be done separately based on the returned output. If the execution return code is needed, either <a href="#Run%20And%20Return%20Rc"
                                                    class="name">Run And Return RC</a> or <a href="#Run%20And%20Return%20Rc%20And%20Output" class="name">Run And Return RC And Output</a> can be used.</p>
                                            <p>The standard error stream is automatically redirected to the standard output stream by adding
                                                ...
                                                <code>my_command 2&gt;stderr.txt</code>.</p>
                                    ...
                                    <div class="keyword" id="wait-until-created">
                                        ...
                                        <div>
                                            ...
                                            <p>The optional <code>timeout</code> can be used to control the maximum time of waiting. The timeout is given as a timeout string, e.g. in a format <code>15 seconds</code>,
                                                <code>1min 10s</code> or just <code>10</code>. The time string format is described in an appendix of Autosphere User Guide.</p>
                    ...
                    <path
                      ...
                      fill="#fff"></path>
                            ...
                            <div><a id="link-append-to-environment-variable" href="#append-to-environment-variable" class="">Append To Environment Variable</a><a id="link-append-to-file" href="#append-to-file" class="">Append To File</a>
                                <a id="link-copy-directory" href="#copy-directory" class="">Copy Directory</a><a id="link-copy-file" href="#copy-file" class="">Copy File</a><a id="link-copy-files" href="#copy-files"
                                    class="">Copy Files</a><a id="link-count-directories-in-directory" href="#count-directories-in-directory" class="">Count Directories In Directory</a><a id="link-count-files-in-directory" href="#count-files-in-directory"
                                    class="">Count Files
                  In Directory</a><a id="link-count-items-in-directory" href="#count-items-in-directory" class="">Count Items In Directory</a><a id="link-create-binary-file" href="#create-binary-file" class="">Create Binary File</a>
                                <a id="link-create-directory" href="#create-directory" class="">Create Directory</a><a id="link-create-file" href="#create-file" class="">Create File</a><a id="link-directory-should-be-empty" href="#directory-should-be-empty"
                                    class="">Directory Should Be Empty</a>
                                <a id="link-directory-should-exist" href="#directory-should-exist" class="">Directory Should Exist
                                            </a><a id="link-directory-should-not-be-empty" href="#directory-should-not-be-empty" class="">Directory Should Not Be Empty</a><a id="link-directory-should-not-exist"
                                    href="#directory-should-not-exist" class="">Directory Should Not Exist</a><a id="link-empty-directory" href="#empty-directory" class="">Empty Directory</a><a id="link-environment-variable-should-be-set"
                                    href="#environment-variable-should-be-set" class="">Environment Variable Should Be Set</a><a id="link-environment-variable-should-not-be-set" href="#environment-variable-should-not-be-set" class="">Environment Variable Should Not
                  ...
                  Environment Variable</a><a id="link-get-environment-variables" href="#get-environment-variables" class="">Get Environment Variables</a><a id="link-get-file" href="#get-file" class="">Get File</a><a id="link-get-file-size"
                                    href="#get-file-size" class="">Get File Size</a><a id="link-get-modified-time" href="#get-modified-time" class="">Get Modified Time</a><a id="link-grep-file" href="#grep-file" class="">Grep File</a>
                                <a id="link-join-path" href="#join-path" class="">Join Path</a><a id="link-join-paths" href="#join-paths" class="">Join Paths</a><a id="link-list-directories-in-directory" href="#list-directories-in-directory"
                                    class="">List Directories In Directory</a>
                  ...
                  File</a><a id="link-move-directory" href="#move-directory" class="">Move Directory</a><a id="link-move-file" href="#move-file" class="">Move File</a><a id="link-move-files" href="#move-files" class="">Move Files</a>
                                <a id="link-normalize-path" href="#normalize-path" class="">Normalize Path</a><a id="link-remove-directory" href="#remove-directory" class="">Remove Directory</a><a id="link-remove-environment-variable"
                                    href="#remove-environment-variable" class="">Remove
                  Environment Variable</a><a id="link-remove-file" href="#remove-file" class="">Remove
                  File</a><a id="link-remove-files" href="#remove-files" class="">Remove Files</a><a id="link-run" href="#run" class="">Run</a><a id="link-run-and-return-rc" href="#run-and-return-rc" class="">Run And Return Rc</a>
                                ...
                                <a id="link-split-extension" href="#split-extension" class="">Split Extension</a><a id="link-split-path" href="#split-path" class="">Split Path</a><a id="link-touch" href="#touch"
                                    class="">Touch</a><a id="link-wait-until-created" href="#wait-until-created" class="">Wait Until Created</a><a id="link-wait-until-removed" href="#wait-until-removed" class="">Wait Until Removed</a></div>
                        </aside>
                    </div>
                </article>
