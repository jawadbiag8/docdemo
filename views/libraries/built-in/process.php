                                ...
                                <div class="sc-jJEJSO laquCT">
                                    <div class="sc-hiSbYr XqbgT">
                                        <div>
                                            ...
                                            <p>When <a href="#Running-processes-in-shell" class="name">running processes in shell</a>, it is also possible to give the whole command to execute as a single string. The command can then contain multiple commands to be run together. When
                                            ...
                                            <p>Note that because <code>**configuration</code> is passed using <code>name=value</code> syntax, possible equal signs in other arguments passed to <a href="documantation.php?page=libraries&node=built-in&subnode=process#run-process" class="name">Run Process</a> and <a href="#Start-Process" class="name">Start Process</a> must be escaped with a backslash like
                                            ...
                                            <p>Giving the <code>shell</code> argument any non-false value, such as <code>shell=True</code>, changes the program to be executed in a shell. It allows using the shell capabilities, but can also make the process invocation operating system dependent.
                                                ...
                                                necessary.</p>
                                            <p>When using a shell it is possible to give the whole command to execute as a single string. See <a href="#Specifying-command-and-arguments" class="name">Specifying command and arguments</a> section for examples and more details in general.</p>
                                            ...
                                            <p><a href="#Standard-output-and-error-streams" class="name">Standard output and error streams</a>, when redirected to files, are also relative to the current working directory possibly set using the
                                            ...
                                            <p>Given <code>stdout</code> and <code>stderr</code> paths are relative to the <a href="#Current-working-directory" class="name">current working directory</a>. Forward slashes in the given paths are automatically converted to backslashes on Windows.</p>
                                            ...
                                            <p>Regardless are outputs redirected to files or not, they are accessible through the <a href="#Result-object" class="name">result object</a> returned when the process ends. Commands are expected to write outputs using the console encoding, but
                                                <a href="#Output-encoding" class="name">output encoding</a> can be configured using the <code>output_encoding</code> argument if needed.
                                            </p>
                                            ...
                                            <p>Executed commands are, by default, expected to write outputs to the <a href="#Standard-output-and-error-streams" class="name">standard output and error streams</a> using the encoding used by the system console. If the command uses some
                                            ...
                                            <p>The value used with the <code>output_encoding</code> argument must be a valid encoding and must match the encoding actually used by the command. As a convenience, it is possible to use strings <code>CONSOLE</code> and <code>SYSTEM</code> to specify
                                                that the console or system encoding is used, respectively. If produced outputs use different encoding then configured, values got through the <a href="#Result-object" class="name">result object</a> will be invalid.</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tbody>
                                                    <tr>
                                                    ...
                                                    <div>
                                                        <div class="keyword" id="get-process-id">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>If <code>handle</code> is not given, uses the current <a href="#active-process" class="name">active process</a>.</p>
                                                                <p>Notice that the pid is not the same as the handle returned by <a href="#start-process" class="name">Start Process</a> that is used internally by this library.</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="keyword" id="get-process-result">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>Returns the specified <a href="#Result-object" class="name">result object</a> or some of its attributes.
                                                                </p>
                                                                <p>The given <code>handle</code> specifies the process whose results should be returned. If no
                                                                    <code>handle</code> is given, results of the current <a href="#active-process" class="name">active process</a> are returned. In either case, the process must have been finishes before this keyword can be used. In practice this
                                                                    means that processes started with <a href="#start-process" class="name">Start Process</a> must be finished either with <a href="#wait-for-process" class="name">Wait For Process</a> or <a href="#terminate-process" class="name">Terminate
                                                                        Process</a> before using this keyword.
                                                                </p>
                                                                <p>If no other arguments than the optional <code>handle</code> are given, a whole <a href="#Result-object" class="name">result object</a> is returned. If one or more of the other arguments are given any true value, only the specified
                                                                    attributes of the <a href="#Result-object" class="name">result
                                                                        object</a> are returned. These attributes are always returned in the same order as arguments are specified in the keyword signature. See <a href="#Boolean-arguments" class="name">Boolean arguments</a> section for more details
                                                                ...
                                                                <p>Although getting results of a previously executed process can be handy in general, the main use case for this keyword is returning results over the remote library interface. The remote interface does not support returning the whole
                                                                    result object, but individual attributes can be returned without problems.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="keyword" id="run-process">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p><code>command</code> and <code>*arguments</code> specify the command to execute and arguments passed to it. See <a href="#Specifying-command-and-arguments" class="name">Specifying
                                                                        command and arguments</a> for more details.</p>
                                                                <p><code>**configuration</code> contains additional configuration related to starting processes and waiting for them to finish. See <a href="#Process-configuration" class="name">Process
                                                                    ...
                                                                    <code>on_timeout</code> arguments that have same semantics as with <a href="#wait-for-process" class="name">Wait For Process</a> keyword. By default there is no timeout, and if timeout is defined the default action on timeout is
                                                                    <code>terminate</code>.
                                                                </p>
                                                                ...
                                                                <p>Note that possible equal signs in <code>*arguments</code> must be escaped with a backslash (e.g.
                                                                    <code>name\=value</code>) to avoid them to be passed in as <code>**configuration</code>.
                                                                </p>
                                                                <p>Examples:</p>
                                                                <table border="1">
                                                                    <tr>
                                                                ...
                                                                <p>This keyword does not change the <a href="#active-process" class="name">active process</a>.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="keyword" id="send-signal-to-process">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>If <code>handle</code> is not given, uses the current <a href="#active-process" class="name">active process</a>.</p>
                                                                <p>Signal can be specified either as an integer as a signal name. In the latter case it is possible to give the name both with or without <code>SIG</code> prefix, but names are case-sensitive. For example, all the examples below send
                                                                    signal <code>INT (2)</code>:</p>
                                                                <table border="1">
                                                                    <tr>
                                                                ...
                                                                <p>This keyword is only supported on Unix-like machines, not on Windows. What signals are supported depends on the system. For a list of existing signals on your system, see the Unix man pages related to signal handling (typically <code>man signal</code> or
                                                                    <code>man 7 signal</code>).
                                                                </p>
                                                                <p>By default sends the signal only to the parent process, not to possible child processes started by it. Notice that when <a href="#Running-processes-in-shell" class="name">running
                                                                ...
                                                                <p>To send the signal to the whole process group, <code>group</code> argument can be set to any true value (see <a href="#Boolean-arguments" class="name">Boolean arguments</a>). This is not supported by Jython, however.
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="keyword" id="split-command-line">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>String is split from spaces, but argument surrounded in quotes may contain spaces in them. If
                                                                    <code>escaping</code> is given a true value, then backslash is treated as an escape character. It can escape unquoted spaces, quotes inside quotes, and so on, but it also requires using double backslashes when using Windows paths.
                                                                </p>
                                                                <p>Examples:</p>
                                                                <table border="1">
                                                                    <tr>
                                                        ...
                                                        <div class="keyword" id="start-process">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>See <a href="#Specifying-command-and-arguments" class="name">Specifying command and
                                                                        arguments</a> and <a href="#Process-configuration" class="name">Process configuration</a> for more information about the arguments, and <a href="#run-process" class="name">Run
                                                                        Process</a> keyword for related examples.</p>
                                                                <p>Makes the started process new <a href="#active-process" class="name">active process</a>. Returns an identifier that can be used as a handle to activate the started process if needed.
                                                                </p>
                                                        ...
                                                        <div class="keyword" id="switch-process">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>Makes the specified process the current <a href="#active-process" class="name">active
                                                                        process</a>.</p>
                                                                <p>The handle can be an identifier returned by <a href="#start-process" class="name">Start
                                                        ...
                                                        <div class="keyword" id="terminate-all-processes">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>By default tries to terminate processes gracefully, but can be configured to forcefully kill them immediately. See <a href="#terminate-process" class="name">Terminate Process</a> that this keyword uses internally for more details.</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="keyword" id="terminate-process">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>If <code>handle</code> is not given, uses the current <a href="#active-process" class="name">active process</a>.</p>
                                                                <p>By default first tries to stop the process gracefully. If the process does not stop in 30 seconds, or <code>kill</code> argument is given a true value, (see <a href="#Boolean-arguments" class="name">Boolean arguments</a>) kills the
                                                                    process forcefully. Stops also all the child processes of the originally started process.
                                                                </p>
                                                                <p>Waits for the process to stop after terminating it. Returns a <a href="#Result-object" class="name">result object</a> containing information about the execution similarly as <a href="#wait-for-process" class="name">Wait For Process</a>.</p>
                                                                <p>On Unix-like machines graceful termination is done using <code>TERM (15)</code> signal and killing using <code>KILL (9)</code>. Use <a href="#Send-Signal-To-Process" class="name">Send Signal To Process</a> instead if you just want
                                                                    to send either of these signals without waiting for the process to stop.</p>
                                                        ...
                                                        <div class="keyword" id="wait-for-process">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p>The process to wait for must have been started earlier with <a href="#start-process" class="name">Start Process</a>. If <code>handle</code> is not given, uses the current <a href="#active-process" class="name">active process</a>.</p>
                                                                ...
                                                                <p>See <a href="#terminate-process" class="name">Terminate Process</a> keyword for more details how processes are terminated and killed.</p>
                                                                <p>If the process ends before the timeout or it is terminated or killed, this keyword returns a <a href="#Result-object" class="name">result object</a> containing information about the execution. If the process is left running, Python
                                                                    <code>None</code> is returned instead.
                                                                </p>
                                                                <p>Examples:</p>
                                                                <table border="1">
                                                                    <tr>
