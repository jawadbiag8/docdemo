                ...
                <path
                  ...
                  fill="#002642"></path>
                        ...
                        <nav class="sc-giIncl cuybkK"><a class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/built-in/builtin">Readme</a><a aria-current="page" class="sc-ezrdKe bAYFRD" href="docs.php?page=libraries/built-in/builtin/keywords">Keywords</a></nav>
                    </div>
                                    ...
                                    <div class="keyword" id="catenate">
                                        ...
                                        <div>
                                            ...
                                            <p>By default, items are catenated with spaces, but if the first item contains the string
                                                <code>SEPARATOR=&lt;sep&gt;</code>, the separator <code>&lt;sep&gt;</code> is used instead. Items are converted into strings when necessary.</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tr>
                                                    <td>${str1} =</td>
                          ...
                          Keyword If</a> or other wrapper keywords.</p>
                                    ...
                                    <div class="keyword" id="continue-for-loop-if">
                                        ...
                                        <div>
                                            ...
                                            <p>A wrapper for <a href="#Continue%20For%20Loop" class="name">Continue For Loop</a> to continue a for loop based on the given condition. The condition is evaluated using the same semantics as with <a href="#Should%20Be%20True"
                                                    class="name">Should Be True</a> keyword.</p>
                                            <h3>Examples</h3>
                                            <table border="1">
                                                <tr>
                                                    <td>FOR</td>
                          ...
                          Integer</a> instead.</p>
                                    ...
                                    <div class="keyword" id="convert-to-string">
                                        ...
                                        <div>
                                            ...
                                            <p>Use Encode String To Bytes and Decode Bytes To String keywords in <code>String</code> library if you need to convert between Unicode and byte strings using different encodings. Use <a href="#Convert%20To%20Bytes"
                                                    class="name">Convert To Bytes</a> if you just want to create byte strings.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="keyword" id="create-dictionary">
                                        ...
                                        <div>
                                            ...
                                            <p>Items are typically given using the <code>key=value</code> syntax same way as
                                                ...
                                                <code>escaped\=key=value</code>. It is also possible to get items from existing dictionaries by simply using them like <code>&amp;{dict}</code>.</p>
                                            <p>Alternatively items can be specified so that keys and values are given separately. This and the
                                                <code>key=value</code> syntax can even be combined, but separately given items must be first. If same key is used multiple times, the last value has precedence.</p>
                                    ...
                                    <div class="keyword" id="evaluate">
                                        ...
                                        <div>
                                            ...
                                            <p>Variables used like <code>${variable}</code> are replaced in the expression before evaluation. Variables are also available in the evaluation namespace and can be accessed using the special
                                                <code>$variable</code> syntax as explained in the <a href="#Evaluating%20expressions" class="name">Evaluating expressions</a> section.</p>
...
${result} = 42
                                    ...
                                    <div class="keyword" id="exit-for-loop-if">
                                        ...
                                        <div>
                                            ...
                                            <p>A wrapper for <a href="#Exit%20For%20Loop" class="name">Exit For Loop</a> to exit a for loop based on the given condition. The condition is evaluated using the same semantics as with <a href="#Should%20Be%20True"
                                                    class="name">Should Be True</a> keyword.</p>
                                            <h3>Examples</h3>
                                            <table border="1">
                                                <tr>
                                    ...
                                    <div class="keyword" id="fail">
                                        ...
                                        <div>
                                            ...
                                            <p>It is possible to modify tags of the current test case by passing tags after the message. Tags starting with a hyphen (e.g. <code>-regression</code>) are removed and others added. Tags are modified using
                                                <a href="#Set%20Tags" class="name">Set Tags</a> and <a href="#Remove%20Tags" class="name">Remove Tags</a> internally, and the semantics setting and removing them are the same as with these keywords.</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tr>
                                                    <td>Fail</td>
                                    ...
                                    <div class="keyword" id="get-count">
                                        ...
                                        <div>
                                            ...
                                            <p>This keyword works with Python strings and lists and all objects that either have
                                                <code>count</code> method or can be converted to Python lists.</p>
                                            <h3>Examples</h3>
                                            <table border="1">
                                                <tr>
                                                    <td>${count} =</td>
                                    ...
                                    <div class="keyword" id="get-time">
                                        ...
                                        <div>
                                            ...
                                            <p>2) If <code>format</code> contains any of the words <code>year</code>, <code>month</code>,
                                                ...
                                                of words in <code>format</code> is not significant. The parts are returned as zero-padded strings (e.g. May -&gt; <code>05</code>).</p>
                                            <p>3) Otherwise (and by default) the time is returned as a timestamp string in the format
                                                <code>2006-02-24 15:08:31</code>.</p>
                                            ...
                                            <p>2) If <code>time</code> is a timestamp, that time will be used. Valid timestamp formats are
                                                <code>YYYY-MM-DD hh:mm:ss</code> and <code>YYYYMMDD hhmmss</code>.</p>
                                            ...
                                            <p>5) If <code>time</code> is in the format like <code>NOW - 1 day</code> or
                                                <code>UTC + 1 hour 30 min</code>, the current local/UTC time plus/minus the time specified with the time string is used. The time string format is described in an appendix of Autosphere User Guide.</p>
...
${z} is set to Python None if it does not exist previously
                                    ...
                                    <div class="keyword" id="get-variables">
                                        ...
                                        <div>
                                            ...
                                            <p>By default variables are returned with <code>${}</code>, <code>@{}</code> or
                                                ...
                                                <code>no_decoration</code> will return the variables without the decoration.</p>
                                            <h3>Examples</h3>
                                            <table border="1">
                                                <tr>
                          ...
                          Level</a> keyword and <code>--loglevel</code> command line option for more details about setting the level.</p>
                                            ...
                                            <p>The <code>formatter</code> argument controls how to format the string representation of the message. Possible values are <code>str</code> (default), <code>repr</code> and
                                                ...
                                                is one item per row. For more details see <a href="#String%20representations" class="name">String representations</a>.</p>
                                            <p>The old way to control string representation was using the <code>repr</code> argument, and
                                                ...
                                                <code>formatter</code> is thus recommended.</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tr>
                                                    <td>Log</td>
                                    ...
                                    <div class="keyword" id="log-to-console">
                                        ...
                                        <div>
                                            ...
                                            <p>By default appends a newline to the logged message. This can be disabled by giving the
                                                <code>no_newline</code> argument a true value (see <a href="#Boolean%20arguments" class="name">Boolean arguments</a>).</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tr>
                          ...
                          Tags</a> internally, and the semantics setting and removing them are the same as with these keywords.
                                            ...
                                            <p>This keyword is typically wrapped to some other keyword, such as <a href="#Run%20Keyword%20If" class="name">Run Keyword If</a>, to pass based on a condition. The most common case can be handled also with
                                                <a href="#Pass%20Execution%20If" class="name">Pass Execution If</a>:</p>
                                            <table border="1">
                                                <tr>
                                                    <td>Run Keyword If</td>
                                                    <td>${rc} &lt; 0</td>
                                    ...
                                    <div class="keyword" id="pass-execution-if">
                                        ...
                                        <div>
                                            ...
                                            <p>A wrapper for <a href="#Pass%20Execution" class="name">Pass Execution</a> to skip rest of the current test, setup or teardown based the given <code>condition</code>. The condition is evaluated similarly as with
                                                <a href="#Should%20Be%20True" class="name">Should Be True</a> keyword, and <code>message</code> and <code>*tags</code> have same semantics as with <a href="#Pass%20Execution" class="name">Pass Execution</a>.</p>
                                            <h3>Examples</h3>
                                            <table border="1">
                                                <tr>
                                                    <td>FOR</td>
                          ...
                          patterns</a> section for more information.</p>
                                    ...
                                    <div class="keyword" id="repeat-keyword">
                                        ...
                                        <div>
                                            ...
                                            <p><code>name</code> and <code>args</code> define the keyword that is executed similarly as with
                                                <a href="#Run%20Keyword" class="name">Run Keyword</a>. <code>repeat</code> specifies how many times (as a count) or how long time (as a timeout) the keyword should be executed.</p>
                                            ...
                                            <p>If <code>repeat</code> is given as timeout, it must be in Autosphere's time format (e.g.
                                                ...
                                                <code>1.5</code>) does not work in this context.</p>
                                    ...
                                    <div class="keyword" id="replace-variables">
                                        ...
                                        <div>
                                            ...
                                            <p>The file <code>template.txt</code> contains <code>Hello ${NAME}!</code> and variable
                                                <code>${NAME}</code> has the value <code>Robot</code>.</p>
                                            <table border="1">
                                                <tr>
                                                    <td>${template} =</td>
                                                    <td>Get File</td>
...
Find Index
   ...
   Return From Keyword    ${-1}    # Also [Return] would work here.
                                            ...
                                            <p>The most common use case, returning based on an expression, can be accomplished directly with
                                                <a href="#Return%20From%20Keyword%20If" class="name">Return From Keyword If</a>. See also <a href="#Run%20Keyword%20And%20Return" class="name">Run Keyword And Return</a> and <a href="#Run%20Keyword%20And%20Return%20If"
                                                    class="name">Run Keyword And Return If</a>.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="keyword" id="return-from-keyword-if">
                                        ...
                                        <div>
                                            ...
                                            <p>A wrapper for <a href="#Return%20From%20Keyword" class="name">Return From Keyword</a> to return based on the given condition. The condition is evaluated using the same semantics as with <a href="#Should%20Be%20True"
                                                    class="name">Should Be True</a> keyword.</p>
...
Find Index
   ...
   Return From Keyword    ${-1}    # Also [Return] would work here.
                                    ...
                                    <div class="keyword" id="run-keyword-and-expect-error">
                                        ...
                                        <div>
                                            ...
                                            <p>The keyword to execute and its arguments are specified using <code>name</code> and
                                                <code>*args</code> exactly like with <a href="#Run%20Keyword" class="name">Run Keyword</a>.</p>
                                    ...
                                    <div class="keyword" id="run-keyword-and-ignore-error">
                                        ...
                                        <div>
                                            ...
                                            <p>This keyword returns two values, so that the first is either string <code>PASS</code> or
                                                <code>FAIL</code>, depending on the status of the executed keyword. The second value is either the return value of the keyword or the received error message. See <a href="#Run%20Keyword%20And%20Return%20Status"
                                                    class="name">Run Keyword And Return Status</a> If you are only interested in the execution status.</p>
                          ...
                          Keyword And Ignore Error</a> instead.</p>
                                            <p>The keyword name and arguments work as in <a href="#Run%20Keyword" class="name">Run
                          Keyword</a>.</p>
                                            <h3>Examples</h3>
                                            <table border="1">
                                    ...
                                    <div class="keyword" id="run-keyword-if">
                                        ...
                                        <div>
                                            ...
                                            <p>The given <code>condition</code> is evaluated in Python as explained in <a href="#Evaluating%20expressions" class="name">Evaluating expressions</a>, and
                                                <code>name</code> and <code>*args</code> have same semantics as with <a href="#Run%20Keyword" class="name">Run Keyword</a>.</p>
                          ...
                          And Ignore Error</a> you can also use <a href="#Run%20Keyword%20And%20Return%20Status" class="name">Run Keyword And Return Status</a>.</p>
                                            ...
                                            <p>This keyword supports also optional ELSE and ELSE IF branches. Both of them are defined in
                                                ...
                                                to have multiple ELSE IF branches. Nested <a href="#Run%20Keyword%20If" class="name">Run Keyword If</a> usage is not supported when using ELSE and/or ELSE IF branches.</p>
                              ...
                              Error</a></td>
                                            ...
                                            <p>The return value of this keyword is the return value of the actually executed keyword or Python
                                                ...
                                                variables (see <a href="#Set%20Variable%20If" class="name">Set Variable If</a> if you need to set fixed values conditionally). This is illustrated by the example below:</p>
                                            <table border="1">
                                                <tr>
                                                    <td>${var1} =</td>
                                                    <td><a href="#Run%20Keyword%20If" class="name">Run Keyword If</a></td>
                                            ...
                                            <p>Notice that <code>ELSE</code> and <code>ELSE IF</code> control words must be used explicitly and thus cannot come from variables. If you need to use literal <code>ELSE</code> and
                                                ...
                                                <code>\ELSE</code> and <code>\ELSE IF</code>.</p>
                          ...
                          Keyword</a>, see its documentation for more details.</p>
                                    ...
                                    <div class="keyword" id="run-keyword-unless">
                                        ...
                                        <div>
                                            ...
                                            <p>See <a href="#Run%20Keyword%20If" class="name">Run Keyword If</a> for more information and an example. Notice that this keyword does not support <code>ELSE</code> or <code>ELSE IF</code> branches like <a href="#Run%20Keyword%20If"
                                                    class="name">Run Keyword If</a> does, though.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="keyword" id="run-keywords">
                                        ...
                                        <div>
                                            ...
                                            <p>Keywords can also be run with arguments using upper case <code>AND</code> as a separator between keywords. The keywords are executed so that the first argument is the first keyword and proceeding arguments until
                                                ...
                                                <code>AND</code> are its arguments. And so on.</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tr>
                                                    <td><a href="#Run%20Keywords" class="name">Run Keywords</a></td>
                                    ...
                                    <div class="keyword" id="set-library-search-order">
                                        ...
                                        <div>
                                            ...
                                            <p>When this keyword is used, there is no need to use the long
                                                <code>LibraryName.Keyword Name</code> notation. For example, instead of having</p>
                                            <table border="1">
                                                <tr>
                                    ...
                                    <div class="keyword" id="set-local-variable">
                                        ...
                                        <div>
                                            ...
                                            <p>This keyword will provide the option of setting local variables inside keywords like <a href="#Run%20Keyword%20If" class="name">Run Keyword If</a>, <a href="#Run%20Keyword%20And%20Return%20If" class="name">Run Keyword And Return If</a>,
                                                <a href="#Run%20Keyword%20Unless" class="name">Run Keyword Unless</a> which until now was not possible by using <a href="#Set%20Variable" class="name">Set Variable</a>.</p>
                                    ...
                                    <div class="keyword" id="set-suite-documentation">
                                        ...
                                        <div>
                                            ...
                                            <p>The documentation of the current suite is available as a built-in variable
                                                <code>${SUITE DOCUMENTATION}</code>.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="keyword" id="set-suite-metadata">
                                        ...
                                        <div>
                                            ...
                                            <p>The metadata of the current suite is available as a built-in variable
                                                <code>${SUITE METADATA}</code> in a Python dictionary. Notice that modifying this variable directly has no effect on the actual metadata the suite has.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="keyword" id="set-suite-variable">
                                        ...
                                        <div>
                                            ...
                                            <p>To override an existing value with an empty value, use built-in variables
                                                <code>${EMPTY}</code>, <code>@{EMPTY}</code> or <code>&amp;{EMPTY}</code>:</p>
                                            <table border="1">
                                                <tr>
                                                    <td>Set Suite Variable</td>
                                                    <td>${SCALAR}</td>
                                    ...
                                    <div class="keyword" id="set-variable">
                                        ...
                                        <div>
                                            ...
                                            <p>Variables created with this keyword are available only in the scope where they are created. See
                                                <a href="#Set%20Global%20Variable" class="name">Set Global Variable</a>, <a href="#Set%20Test%20Variable" class="name">Set Test Variable</a> and <a href="#Set%20Suite%20Variable" class="name">Set Suite Variable</a>                                                for information on how to set variables so that they are available also in a larger scope.</p>
                                        </div>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <ul>
                                                ...
                                                <li><code>formatter</code> controls how to format the values. Possible values are
                                                    <code>str</code> (default), <code>repr</code> and <code>ascii</code>, and they work similarly as Python built-in functions with same names. See <a href="#String%20representations" class="name">String representations</a>                                                    for more details.</li>
                                            </ul>
                                    ...
                                    <div class="keyword" id="should-contain-any">
                                        ...
                                        <div>
                                            ...
                                            <p>Supports additional configuration parameters <code>msg</code>, <code>values</code> and
                                                ...
                                                <code>name=value</code> syntax after all <code>items</code>.</p>
                                            <p>Note that possible equal signs in <code>items</code> must be escaped with a backslash (e.g.
                                                <code>foo\=bar</code>) to avoid them to be passed in as <code>**configuration</code>.</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tr>
                                    ...
                                    <div class="keyword" id="should-match-regexp">
                                        ...
                                        <div>
                                            ...
                                            <p>Possible flags altering how the expression is parsed (e.g. <code>re.IGNORECASE</code>,
                                                ...
                                                <code>s</code> (dotall mode) and <code>x</code> (verbose).</p>
...
${group2} = '43'
                                    ...
                                    <div class="keyword" id="should-not-be-equal-as-numbers">
                                        ...
                                        <div>
                                            ...
                                            <p>The conversion is done with <a href="#Convert%20To%20Number" class="name">Convert To Number</a> keyword using the given <code>precision</code>.</p>
                                            <p>See <a href="#Should%20Be%20Equal%20As%20Numbers" class="name">Should Be Equal As Numbers</a> for examples on how to use <code>precision</code> and why it does not always work as expected. See also <a href="#Should%20Be%20Equal"
                                                    class="name">Should Be Equal</a> for an explanation on how to override the default error message with <code>msg</code> and <code>values</code>.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="keyword" id="should-not-be-true">
                                        ...
                                        <div>
                                            ...
                                            <p>See <a href="#Should%20Be%20True" class="name">Should Be True</a> for details about how
                                                <code>condition</code> is evaluated and how <code>msg</code> can be used to override the default error message.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="keyword" id="should-not-contain">
                                        ...
                                        <div>
                                            ...
                                            <p>Works with strings, lists, and anything that supports Python's <code>in</code> operator.</p>
                                            <p>See <a href="#Should%20Be%20Equal" class="name">Should Be Equal</a> for an explanation on how to override the default error message with arguments <code>msg</code> and <code>values</code>.
                                                <code>ignore_case</code> has exactly the same semantics as with <a href="#Should%20Contain" class="name">Should Contain</a>.</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tr>
                                    ...
                                    <div class="keyword" id="sleep">
                                        ...
                                        <div>
                                            ...
                                            <p><code>time</code> may be either a number or a time string. Time strings are in a format such as
                                                ...
                                                why sleeping is necessary. Both the time slept and the reason are logged.</p>
                                            <p>Examples:</p>
                                            <table border="1">
                                                <tr>
                                                    <td>Sleep</td>
                                    ...
                                    <div class="keyword" id="wait-until-keyword-succeeds">
                                        ...
                                        <div>
                                            ...
                                            <p><code>name</code> and <code>args</code> define the keyword that is executed similarly as with
                                                ...
                                                <code>retry_interval</code> is the time to wait before trying to run the keyword again after the previous run has failed.</p>
                                            <p>If <code>retry</code> is given as timeout, it must be in Autosphere's time format (e.g.
                                                ...
                                                <code>retry_interval</code> must always be given in Autosphere's time format.</p>
                    ...
                    <path
                      ...
                      fill="#fff"></path>
                            ...
                            <div><a id="link-call-method" href="#call-method" class="">Call Method</a><a id="link-catenate" href="#catenate" class="">Catenate</a><a id="link-comment" href="#comment" class="">Comment</a>
                                <a id="link-continue-for-loop" href="#continue-for-loop" class="">Continue For Loop</a><a id="link-continue-for-loop-if" href="#continue-for-loop-if" class="">Continue For Loop If</a><a id="link-convert-to-binary"
                                    href="#convert-to-binary" class="">Convert To Binary</a>
                                <a id="link-convert-to-boolean" href="#convert-to-boolean" class="">Convert To Boolean</a><a id="link-convert-to-bytes" href="#convert-to-bytes" class="">Convert To Bytes</a><a id="link-convert-to-hex"
                                    href="#convert-to-hex" class="">Convert To Hex</a><a id="link-convert-to-integer" href="#convert-to-integer" class="">Convert To Integer</a><a id="link-convert-to-number" href="#convert-to-number"
                                    class="">Convert To Number</a><a id="link-convert-to-octal" href="#convert-to-octal" class="">Convert To Octal</a><a id="link-convert-to-string" href="#convert-to-string" class="">Convert To String</a>
                  ...
                  Instance</a><a id="link-get-time" href="#get-time" class="">Get Time</a><a id="link-get-variable-value" href="#get-variable-value" class="">Get Variable Value</a><a id="link-get-variables" href="#get-variables"
                                    class="">Get Variables</a><a id="link-import-library" href="#import-library" class="">Import Library</a><a id="link-import-resource" href="#import-resource" class="">Import Resource</a>
                  ...
                  Be</a><a id="link-log" href="#log" class="">Log</a><a id="link-log-many" href="#log-many" class="">Log Many</a><a id="link-log-to-console" href="#log-to-console" class="">Log To Console</a><a id="link-log-variables"
                                    href="#log-variables" class="">Log Variables</a><a id="link-no-operation" href="#no-operation" class="">No Operation</a><a id="link-pass-execution" href="#pass-execution" class="">Pass Execution</a>
                                ...
                                <a id="link-reload-library" href="#reload-library" class="">Reload Library</a><a id="link-remove-tags" href="#remove-tags" class="">Remove Tags</a><a id="link-repeat-keyword" href="#repeat-keyword"
                                    class="">Repeat Keyword</a><a id="link-replace-variables" href="#replace-variables" class="">Replace Variables</a><a id="link-return-from-keyword" href="#return-from-keyword" class="">Return From Keyword</a>
                                <a id="link-return-from-keyword-if" href="#return-from-keyword-if" class="">Return From Keyword If</a><a id="link-run-keyword" href="#run-keyword" class="">Run Keyword</a><a id="link-run-keyword-and-continue-on-failure"
                                    href="#run-keyword-and-continue-on-failure" class="">Run Keyword And Continue On Failure</a>
                                <a id="link-run-keyword-and-expect-error" href="#run-keyword-and-expect-error" class="">Run Keyword And Expect Error</a><a id="link-run-keyword-and-ignore-error" href="#run-keyword-and-ignore-error"
                                    class="">Run
                  ...
                  Keyword And Return If</a><a id="link-run-keyword-and-return-status" href="#run-keyword-and-return-status" class="">Run Keyword And Return Status</a><a id="link-run-keyword-if" href="#run-keyword-if" class="">Run Keyword If</a>
                                <a id="link-run-keyword-if-all-critical-tests-passed" href="#run-keyword-if-all-critical-tests-passed" class="">Run Keyword If All Critical Tests Passed</a><a id="link-run-keyword-if-all-tests-passed" href="#run-keyword-if-all-tests-passed"
                                    class="">Run Keyword If All Tests Passed</a><a id="link-run-keyword-if-any-critical-tests-failed" href="#run-keyword-if-any-critical-tests-failed" class="">Run Keyword If Any Critical
                  Tests Failed</a><a id="link-run-keyword-if-any-tests-failed" href="#run-keyword-if-any-tests-failed" class="">Run Keyword If Any Tests Failed</a><a id="link-run-keyword-if-test-failed" href="#run-keyword-if-test-failed"
                                    class="">Run
                  Keyword If Test Failed</a><a id="link-run-keyword-if-test-passed" href="#run-keyword-if-test-passed" class="">Run Keyword If Test Passed</a><a id="link-run-keyword-if-timeout-occurred" href="#run-keyword-if-timeout-occurred"
                                    class="">Run Keyword If Timeout Occurred</a><a id="link-run-keyword-unless" href="#run-keyword-unless" class="">Run Keyword Unless</a><a id="link-run-keywords" href="#run-keywords" class="">Run Keywords</a>
                  ...
                  Level</a><a id="link-set-suite-documentation" href="#set-suite-documentation" class="">Set Suite Documentation</a><a id="link-set-suite-metadata" href="#set-suite-metadata" class="">Set Suite Metadata</a>
                                <a id="link-set-suite-variable" href="#set-suite-variable" class="">Set Suite Variable</a><a id="link-set-tags" href="#set-tags" class="">Set Tags</a><a id="link-set-task-variable" href="#set-task-variable"
                                    class="">Set Task Variable</a>
                  ...
                  Variable</a><a id="link-set-variable" href="#set-variable" class="">Set Variable</a><a id="link-set-variable-if" href="#set-variable-if" class="">Set Variable If</a><a id="link-should-be-empty" href="#should-be-empty"
                                    class="">Should Be Empty</a><a id="link-should-be-equal" href="#should-be-equal" class="">Should Be Equal</a><a id="link-should-be-equal-as-integers" href="#should-be-equal-as-integers" class="">Should
                  Be Equal As Integers</a><a id="link-should-be-equal-as-numbers" href="#should-be-equal-as-numbers" class="">Should Be Equal As Numbers</a><a id="link-should-be-equal-as-strings" href="#should-be-equal-as-strings"
                                    class="">Should
                  ...
                  Contain Any</a><a id="link-should-contain-x-times" href="#should-contain-x-times" class="">Should Contain X Times</a><a id="link-should-end-with" href="#should-end-with" class="">Should End With</a><a id="link-should-match"
                                    href="#should-match" class="">Should Match</a><a id="link-should-match-regexp" href="#should-match-regexp" class="">Should Match Regexp</a><a id="link-should-not-be-empty" href="#should-not-be-empty"
                                    class="">Should Not Be Empty</a><a id="link-should-not-be-equal" href="#should-not-be-equal" class="">Should Not Be
                  Equal</a><a id="link-should-not-be-equal-as-integers" href="#should-not-be-equal-as-integers" class="">Should Not Be Equal As Integers</a><a id="link-should-not-be-equal-as-numbers" href="#should-not-be-equal-as-numbers"
                                    class="">Should Not Be Equal As Numbers</a><a id="link-should-not-be-equal-as-strings" href="#should-not-be-equal-as-strings" class="">Should Not Be Equal As Strings</a>
                  ...
                  Exist</a><a id="link-variable-should-not-exist" href="#variable-should-not-exist" class="">Variable Should Not Exist</a><a id="link-wait-until-keyword-succeeds" href="#wait-until-keyword-succeeds" class="">Wait Until Keyword Succeeds</a></div>
                        </aside>
                    </div>
                </article>
