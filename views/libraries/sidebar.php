<div class="menu">
    <ul class="list">
        ...
        <li class="<?php
        if ($node == "Autosphere-framework") {
            echo 'active';
        }
        ?>">
            <a href="javascript:void(0);" class="menu-toggle">
                <i class="material-icons">local_library</i>
                <span>Autosphere Package</span>
            </a>
            <ul class="ml-menu">
                <li class="<?php
                ...
                <li class="<?php
                if ($subnode == "Autosphere-database") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-desktop-clipboard") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-desktop-operatingsystem") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-desktop-windows") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-email-exchange") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-email-imapsmtp") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-excel-application") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-excel-files") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-filesystem") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-netsuite") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-notifier") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-outlook-application") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-robot-log-listener") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-salesforce") {
                    echo 'active';
                }
                ?>">
                ...
                <li class="<?php
                if ($subnode == "Autosphere-word-application") {
                    echo 'active';
                }
                ?>">
        ...
        ?>">
            ...
            <ul class="ml-menu">
                ...
                ?>">
                    <a href="documantation.php?page=libraries&node=built-in&subnode=intro">
                        <span>Intro</span>
                    </a>
                </li>
                <li class="<?php
